...
if '__main__' == __name__:
    ...
    parser.add_argument('-cl', '--cov_lim', type=int, default=None, help='coverage starting lim')
    parser.add_argument('--tvmfuzz', type=str, nargs='?', help='TVMFuzz coverage by time file')
